...
void main() {
  test('quality failure cannot resolve to green', () {
    final result = ScoringEngine.score(SessionFeatures(
      vttlMs: 0, pfvStd: 0, cvrRatio: 0, childAgeMonths: 24,
      analysisStatus: 'INCOMPLETE', qualityReasons: const ['too quiet'],
    ));
