...
class MainActivity : FlutterActivity() {
    ...
    private val audioRecorder = UnprocessedAudioRecorder()
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                "startRecording" -> {
                    ...
                    if (started) result.success(true) else result.error("ERR_MIC_LOCKED", "Could not initialize audio recorder", null)
                }
                "stopRecording" -> {
                ...
                "runPipeline" -> {
                    ...
                    try {
                        ...
                        val features = mapOf(
                            ...
                            "child_age_months" to childAgeMonths,
